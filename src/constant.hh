...
typedef enum erreur
{
    ...
    MOUVEMENTS_INSUFFISANTS, ///< Il ne reste plus assez de points de mouvements
...
typedef enum type_case
{
    ...
    PAPY, ///< Élément traversable générant de manière périodique des miches de
          ///< pain
