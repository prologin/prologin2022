...
PyObject* cxx_to_python<PyObject*, troupe>(troupe in)
{
    ...
    PyTuple_SET_ITEM(tuple, 4, (cxx_to_python<PyObject*, int>(in.id)));
...
PyObject* cxx_to_python<PyObject*, etat_case>(etat_case in)
{
    ...
    PyTuple_SET_ITEM(tuple, 3,
                     (cxx_to_python<PyObject*, bool>(in.contient_pain)));
...
etat_case python_to_cxx<PyObject*, etat_case>(PyObject* in)
{
    ...
    // La case contient une miche de pain
    i = cxx_to_python<PyObject*, int>(3);
    i = PyObject_GetItem(in, i);
    if (i == nullptr)
        throw 42;
    out.contient_pain = python_to_cxx<PyObject*, bool>(i);
    Py_DECREF(i);
