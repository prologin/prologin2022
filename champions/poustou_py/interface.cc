...
typedef enum erreur
{
    ...
    SCORE_INSUFFISANT, ///< Le joueur n'a pas assez de points pour construire un
                       ///< buisson
...
typedef struct etat_case
{
    ...
    bool nb_pains;          ///< La case contient une miche de pain
} etat_case;
...
PyObject* cxx_to_python<PyObject*, etat_case>(etat_case in)
{
    ...
    PyTuple_SET_ITEM(tuple, 1,
                     (cxx_to_python<PyObject*, type_case>(in.contenu)));
    PyTuple_SET_ITEM(tuple, 2,
                     (cxx_to_python<PyObject*, bool>(in.est_constructible)));
    PyTuple_SET_ITEM(tuple, 3, (cxx_to_python<PyObject*, bool>(in.nb_pains)));
...
etat_case python_to_cxx<PyObject*, etat_case>(PyObject* in)
{
    ...
    if (i == nullptr)
        throw 42;
    out.nb_pains = python_to_cxx<PyObject*, bool>(i);
    Py_DECREF(i);
...
PyObject* cxx_to_python<PyObject*, action_hist>(action_hist in)
{
    ...
    PyTuple_SET_ITEM(tuple, 0,
                     (cxx_to_python<PyObject*, type_action>(in.action_type)));
    PyTuple_SET_ITEM(tuple, 1, (cxx_to_python<PyObject*, int>(in.troupe_id)));
    PyTuple_SET_ITEM(tuple, 2,
                     (cxx_to_python<PyObject*, direction>(in.action_dir)));
    PyTuple_SET_ITEM(tuple, 3,
                     (cxx_to_python<PyObject*, position>(in.action_pos)));
...
static PyObject* p_avancer(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, erreur>(
            api_avancer(python_to_cxx<PyObject*, int>(arg_id),
                        python_to_cxx<PyObject*, direction>(arg_dir)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_grandir(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, erreur>(
            api_grandir(python_to_cxx<PyObject*, int>(arg_id)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_construire_buisson(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, erreur>(api_construire_buisson(
            python_to_cxx<PyObject*, position>(arg_pos)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_creuser_tunnel(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, erreur>(
            api_creuser_tunnel(python_to_cxx<PyObject*, position>(arg_pos)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_info_case(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, etat_case>(
            api_info_case(python_to_cxx<PyObject*, position>(arg_pos)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_info_barriere(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, etat_barriere>(
            api_info_barriere(python_to_cxx<PyObject*, position>(arg_pos)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_info_nid(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, etat_nid>(
            api_info_nid(python_to_cxx<PyObject*, position>(arg_pos)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_papy_tours_restants(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, int>(api_papy_tours_restants(
            python_to_cxx<PyObject*, position>(arg_pos)));
    }
    catch (...)
    {
...
static PyObject* p_troupes_joueur(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python_array(
            api_troupes_joueur(python_to_cxx<PyObject*, int>(arg_id_joueur)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_debug_poser_pigeon(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, erreur>(api_debug_poser_pigeon(
            python_to_cxx<PyObject*, position>(arg_pos),
            python_to_cxx<PyObject*, pigeon_debug>(arg_pigeon)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_gain(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        return cxx_to_python<PyObject*, int>(
            api_gain(python_to_cxx<PyObject*, int>(arg_nb_pains)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_score(PyObject* /* self */, PyObject* args)
{
    ...
    {
        return cxx_to_python<PyObject*, int>(
            api_score(python_to_cxx<PyObject*, int>(arg_id_joueur)));
    }
    catch (...)
    {
        return nullptr;
...
static PyObject* p_afficher_etat_barriere(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        (api_afficher_etat_barriere(
            python_to_cxx<PyObject*, etat_barriere>(arg_v)));
        Py_RETURN_NONE;
    }
    catch (...)
    {
...
static PyObject* p_afficher_pigeon_debug(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        (api_afficher_pigeon_debug(
            python_to_cxx<PyObject*, pigeon_debug>(arg_v)));
        Py_RETURN_NONE;
    }
    catch (...)
    {
...
static PyObject* p_afficher_type_action(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        (api_afficher_type_action(
            python_to_cxx<PyObject*, type_action>(arg_v)));
        Py_RETURN_NONE;
    }
    catch (...)
    {
...
static PyObject* p_afficher_action_hist(PyObject* /* self */, PyObject* args)
{
    ...
    try
    {
        (api_afficher_action_hist(
            python_to_cxx<PyObject*, action_hist>(arg_v)));
        Py_RETURN_NONE;
    }
    catch (...)
    {
...
static PyMethodDef api_callback[] = {
    ...
    {"construire_buisson", p_construire_buisson, METH_VARARGS,
     "construire_buisson"},
    ...
    {"papy_tours_restants", p_papy_tours_restants, METH_VARARGS,
     "papy_tours_restants"},
    {"troupes_joueur", p_troupes_joueur, METH_VARARGS, "troupes_joueur"},
    {"pains", p_pains, METH_VARARGS, "pains"},
    {"debug_poser_pigeon", p_debug_poser_pigeon, METH_VARARGS,
     "debug_poser_pigeon"},
    ...
    {"afficher_direction", p_afficher_direction, METH_VARARGS,
     "afficher_direction"},
    {"afficher_type_case", p_afficher_type_case, METH_VARARGS,
     "afficher_type_case"},
    {"afficher_etat_barriere", p_afficher_etat_barriere, METH_VARARGS,
     "afficher_etat_barriere"},
    {"afficher_etat_nid", p_afficher_etat_nid, METH_VARARGS,
     "afficher_etat_nid"},
    {"afficher_pigeon_debug", p_afficher_pigeon_debug, METH_VARARGS,
     "afficher_pigeon_debug"},
    {"afficher_type_action", p_afficher_type_action, METH_VARARGS,
     "afficher_type_action"},
    {"afficher_position", p_afficher_position, METH_VARARGS,
     "afficher_position"},
    {"afficher_troupe", p_afficher_troupe, METH_VARARGS, "afficher_troupe"},
    {"afficher_etat_case", p_afficher_etat_case, METH_VARARGS,
     "afficher_etat_case"},
    {"afficher_action_hist", p_afficher_action_hist, METH_VARARGS,
